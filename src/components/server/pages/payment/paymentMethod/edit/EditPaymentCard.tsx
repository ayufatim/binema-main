...
function EditPaymentCard({paymentCard}: {paymentCard: SafePaymentCard}) {
    ...
    const { handleSubmit, reset, register, setValue, watch, formState: { errors } } = useForm<FieldValues>({
        defaultValues: {
            nameCard: paymentCard.nameCard,
            numberCard: paymentCard.numberCard,
            imageCard: paymentCard.imageCard,
            imageQR: paymentCard.imageQR
        }
    });
    ...
    const onSubmit: SubmitHandler<FieldValues> = async (data) => {
        ...
        try {
            console.log(data)
            await axios.put(`/api/payment/paymentCard/${paymentCard.id}`, data);
