...
function EditPricingPlan({paymentPlan}: {paymentPlan: any}) {
    ...
    const { handleSubmit, reset, register, formState: { errors }, setValue } = useForm<FieldValues>({
        defaultValues: {
            ...
            capacity: paymentPlan.capacity,
            screenResolution: paymentPlan.screenResolution,
    ...
    const onSubmit: SubmitHandler<FieldValues> = async (data) => {
        ...
        try {
            ...
            await axios.put(`/api/payment/paymentPlan/${paymentPlan.id}`, newData);
    
            await Swal.fire({
                icon: 'success',
                title: 'Success',
                text: 'Pricing edited successfully!',
            });
